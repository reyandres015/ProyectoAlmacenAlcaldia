...
public class VentanaTablaContratos extends JFrame implements MouseListener {
     ...
     * @return
     */
    private ArrayList<Contrato> consultarListaPersonas() throws IOException {
    ...
    private Object[][] obtenerMatrizDatos(ArrayList<String> titulosList) {
        ...
        for (int x = 0; x < informacion.length; x++) {
            ...
            informacion[x][Utilidades.FECHA] = listaPersonas.get(x).getFecha() + "";
            informacion[x][Utilidades.OBJETO] = listaPersonas.get(x).getObjeto() + "";
            informacion[x][Utilidades.REFERENCIA] = listaPersonas.get(x).getReferencia() + "";
            informacion[x][Utilidades.EMPRESA] = listaPersonas.get(x).getProveedor().getEmpresa() + "";
            informacion[x][Utilidades.CELULAR] = listaPersonas.get(x).getProveedor().getRepresentanteLegal().getCelular() + "";
            informacion[x][Utilidades.VALORTOTAL] = listaPersonas.get(x).getValorTotal() + "";
    ...
    private void construirTabla(String[] titulos, Object[][] data) {
        ...
        tablaContratos.getColumnModel().getColumn(Utilidades.VALORTOTAL).setCellRenderer(new GestionCeldas("numerico"));
        tablaContratos.getColumnModel().getColumn(Utilidades.PERFIL).setCellRenderer(new GestionCeldas("icono"));
        tablaContratos.getColumnModel().getColumn(Utilidades.EVENTO).setCellRenderer(new GestionCeldas("icono"));
        ...
        tablaContratos.getColumnModel().getColumn(Utilidades.FECHA).setPreferredWidth(130);//fecha
        tablaContratos.getColumnModel().getColumn(Utilidades.OBJETO).setPreferredWidth(380);//objetoContrato
        tablaContratos.getColumnModel().getColumn(Utilidades.REFERENCIA).setPreferredWidth(350);//referenciaContrato
        tablaContratos.getColumnModel().getColumn(Utilidades.EMPRESA).setPreferredWidth(130);//nombreEmpresa
        tablaContratos.getColumnModel().getColumn(Utilidades.CELULAR).setPreferredWidth(280);//celularEmpresa
        tablaContratos.getColumnModel().getColumn(Utilidades.VALORTOTAL).setPreferredWidth(80);//valortotal
        tablaContratos.getColumnModel().getColumn(Utilidades.PERFIL).setPreferredWidth(30);//accion perfil
        tablaContratos.getColumnModel().getColumn(Utilidades.EVENTO).setPreferredWidth(30);//accion evento
    ...
    private void validarSeleccionMouse(int fila) throws IOException {
        ...
        Contrato contrato = miContrato.buscarContratoReferencia(tablaContratos.getValueAt(fila, Utilidades.REFERENCIA).toString());
